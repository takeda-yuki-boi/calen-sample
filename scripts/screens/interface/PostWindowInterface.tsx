...
interface IProps {
    ...
    // route: RouteProp<{ params: PostWindowRequest }, 'params'>;
    // redux: ReduxData;
...
export type PostWindowNavigateRequest = NavigationProps & NavigationPropsForState;
export type PostWindowRequest = PostWindowNavigateRequest & NavigationPropsForFactory;
export type PostWindowResponse = ScreenResponse;